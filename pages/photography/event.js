...
export function EventPhotographyContent() {
    ...
    const photos = [
        {
            src: "/images/photography/event/hs-nashville-2023/insta1.jpg",
            width: 4,
            height: 5
        },
        {
            src: "/images/photography/event/hs-nashville-2023/insta2.jpg",
            width: 4,
            height: 5
        },
        {
            src: "/images/photography/event/hs-nashville-2023/insta3.jpg",
            width: 4,
            height: 5
        },
        {
            src: "/images/photography/event/hs-nashville-2023/insta4.jpg",
            width: 4,
            height: 5
        },
        {
        ...
        {
            src: "/images/photography/event/hs-nashville-2023/insta7.jpg",
            width: 4,
            height: 5
        },
        // {
